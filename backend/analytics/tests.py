...
class AnalyticsModuleTests(APITestCase):
    def setUp(self):
        ...
        self.manager = User.objects.create_user(
            username='manager_test', email='manager@t.com', password='pwd', role='MANAGER'
        )
    ...
    def test_analytics_endpoints_permissions(self):
        ...
        # Employee: forbidden (403) for all
        ...
        for name in endpoints:
            ...
            self.assertEqual(
                ...
                f"Endpoint {name} was not forbidden for Employee"
            )
        ...
        for name in endpoints:
            ...
            self.assertEqual(
                response.status_code, status.HTTP_200_OK,
                f"Endpoint {name} failed for Manager"
            )
